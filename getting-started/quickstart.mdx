...
<Steps>
  <Step title="Sign Up">
    Visit [app.hookflo.dev](https://app.hookflo.dev) and create a new account or sign in with an existing one.
  </Step>
  <Step title="Create a Project">
    Once logged in, create a new project by clicking the "New Project" button and providing a name.
  </Step>
  <Step title="Access Your Dashboard">
    Navigate to your project dashboard where you'll set up integrations and channels.
  </Step>
</Steps>
...
<Steps>
  ...
  <Step title="Define Trigger">
    Specify which webhook events should trigger this alert.
  </Step>
  <Step title="Select Channel">
    Choose which notification channel(s) should receive the alert.
  </Step>
  <Step title="Customize Message">
    Configure the alert content, including text, variables, and formatting.
  </Step>
</Steps>
...
<CardGroup cols={2}>
  <Card
    ...
    icon="plus"
    href="/webhook-platforms/overview"
  >
  ...
  <Card
    ...
    icon="bell"
    href="/notification-channels/overview"
  >
  ...
  >
    Use our API for programmatic control of HookFlo.
  </Card>
</CardGroup>