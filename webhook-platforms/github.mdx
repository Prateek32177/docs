...
<Steps>
  <Step title="Configure Repository-Level Webhook">
    <Accordion title="Setting Up Repository Webhooks">
       ...
       7. (Optional but recommended) Enter a secret in the **Secret** field
      ...
      <div className="w-full">
      ![GitHub Repository Webhook Setup](/github/repo-webhook-setup.png)
  ...
  <Step title="Configure Organization-Level Webhook">
    <Accordion title="Setting Up Organization Webhooks">
      ...
      <div className="w-full">
      ![GitHub Organization Webhook Setup](/github/org-webhook-setup.png)

      </div>
    </Accordion>
  </Step>
  <Step title="Configure Webhook Secret in HookFlo (Optional)">
