...
<Frame>
  <img src="/logo/supabase-logo-wordmark--dark.png" style={{ borderRadius: '0.5rem' }} />
</Frame>
...
<Steps>
  <Step title="Create a Webhook">
    <Accordion title="Setting Up Your Webhook Endpoint">
      ...
      ![Create Webhook Screen](/images/supabase/create-webhook-hookflo.png)
      </div>
  ...
  <Step title="Setup Notification Channel">
    <Accordion title="Configure Email Notifications">
      ...
      <div className="w-full">
      ![Email Configuration Dialog](/images/supabase/email-configuration.png)
      </div>
    </Accordion>
    <Accordion title="Configure Slack Notifications">
      ...
      <div className="w-full">
      ![Slack Configuration Dialog](/images/supabase/slack-configuration.png)
      </div>
    </Accordion>
  </Step>
  <Step title="Connect your Webhook with application">
    <Accordion title="Configure Application">
      ...
      <div className="w-full">
      ![Connection Configuration Panel](/images/supabase/configure-application.png)
      </div>
...
<Steps>
  <Step title="Setup Supabase Webhook">
    <Accordion title="Access Supabase Webhooks">
      ...
      <div className="w-full">
      ![Supabase Dashboard Navigation](/images/supabase/choose-database-webhooks.png)
      </div>
  ...
  <Step title="Create a Database Webhook">
    <Accordion title="Configure Webhook Details">
      ...
      <div className="w-full">
      ![Create Database Webhook Form](/images/supabase/create-webhook.png)
      </div>

      <div className="w-full">
      ![Create Database Webhook Form](/images/supabase/configure-secret-url-values.png)
      </div>
