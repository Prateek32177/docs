...
3. **Delivers notifications**: Sends alerts to the configured channels
4. **Logs notifications**: Log all the event delivery in Notification Logs
...
If you need to integrate with a platform that isn't listed here, you can use our [generic webhook](/webhook-platforms/generic) option which provides a flexible endpoint that can accept webhooks from any source. but payload would be unsigned in this case.
...
Have a platform you'd like us to support? [Let us know](mailto:team.hookflo@gmail.com)\
